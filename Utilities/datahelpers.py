...
class AllowedRole(CreatedRole):
    def __init__(self, id: str, guild_id: int, user_id: int, max_roles: int, allow_badges: bool, allow_gradients: bool, created_date: datetime, updated_user_id: int, updated_date: datetime):
